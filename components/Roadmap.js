  ...
  return (
    <section id="roadmap" className="py-24 px-6 max-w-6xl mx-auto">
      ...
      <div className="text-center mb-24">
        <h2 className="text-6xl md:text-8xl font-black uppercase italic text-lime-400 mb-6 leading-tight">
          THE ROADMAP
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
        <div className="bg-emerald-900/30 border border-emerald-800 p-8 rounded-3xl backdrop-blur-sm">
        ...
        {roadmapData.map((phase, i) => (
          <div key={i} className="relative pl-12 border-l-2 border-emerald-800 group">
            ...
            <div className="flex flex-col md:flex-row md:items-start gap-8">
              ...
              <div className="md:w-3/4 bg-emerald-900/20 border border-emerald-800/50 p-8 rounded-3xl group-hover:border-emerald-600 transition-colors backdrop-blur-sm">
                <h3 className="text-3xl font-black uppercase mb-6 text-white italic">{phase.title}</h3>
      ...
      {/* FINAL CTA */}
      <div className="mt-32 bg-lime-400 p-12 md:p-20 rounded-[40px] md:rounded-[60px] text-emerald-950 text-center relative overflow-hidden shadow-2xl">
        <div className="relative z-10">
          ...
          <a 
            ...
            className="inline-block bg-emerald-950 text-white font-black px-12 py-6 rounded-2xl text-xl uppercase hover:scale-105 transition-transform shadow-xl"
          >
            Claim My Airdrop
          </a>
        </div>
